...
These remappings are achieved by modifying the complex remappings in the `karabiner.json` configuration file.
...
The default keyboard layout after software remapping is shown below.
...
When the super key is held down, the keyboard changes to this:
